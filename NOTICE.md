...
| SGIS census boundaries and population | Origins | Not bundled here; the release ships the synthetic example instead. SGIS content marked KOGL (Korea Open Government License) Type 1 is redistributable with attribution | SGIS portal |
| Korea Federation of Banks branch status | Destinations | Private association; site asserts all rights reserved | KFB website: Disclosures → Data Room → Other materials |
