...
To download, follow the site menus: 정보공개 (information disclosure) → 자료신청 (data request) → 교통분석자료 신청 (transport analysis data) → 대중교통 GTFS (public transit GTFS). The site is Korean only; a browser translator is enough to complete the request form.
:::
