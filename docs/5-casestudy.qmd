...
We analyze **about 100,000 census tracts** over **four years** (2021–2024), comparing car and transit. The results illustrate the workflow's outputs and the patterns available from multi-year, multimodal analysis.

## The Decline in Bank Branches

Bank branches in South Korea have been closing steadily, the trend that motivates this analysis. The country had 6,563 branches in early 2019; by early 2025, only 5,434 remained, a **17% decline** over six years. The dark bars in the figure mark the four year-end branch snapshots (2020–2023) analyzed below. Each snapshot is paired with the following March's transit and road networks, so we label the analysis years 2021–2024.
...
Population with access held steady: car at 92–93%, transit dipping slightly from 89% to 88%. But **median banks reachable fell each year**: from 58 to 47 for car (−19%), from 27 to 18 for transit (−33%). This pattern is consistent with closures occurring where nearby alternatives remained. Most people retained *some* access but had **fewer options** to choose from.

## Where Access Declined

The national trends above used medians, which smooth over regional anomalies. For district-level analysis, we restrict the period to 2021–2023. The 2024 GTFS for Busan showed abnormally short trip durations, and such errors distort spatial comparisons even when they have less influence on national aggregates.
...
The mismatch matters: most districts in (a) do not appear in (b) or (c). Urban districts more often show large losses in reachable options, while rural districts more often show large percentage losses.
...
-   **Elderly share** (panels a, b): Districts with more elderly saw *smaller* declines. This pattern is consistent with a floor effect: these areas had few banks to begin with.
-   **Population density** (panels c, d): Denser districts lost more. Urban branches consolidated; rural areas had little left to lose.

Transit correlations are stronger than car correlations. Higher population density is associated with larger declines, especially for transit, while higher elderly share is associated with smaller declines.
